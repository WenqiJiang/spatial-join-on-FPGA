...
void result_burst_buffer(
    ...
    const int max_burst_length = 128;
...
#pragma HLS pipeline II=1
                ...
                if (result.last || burst_length == max_burst_length) {
                    break;
                }
            }
...
// out
#pragma HLS INTERFACE m_axi port=out_intersect  offset=slave bundle=gmem2 max_write_burst_length=128
