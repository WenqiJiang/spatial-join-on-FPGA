...
// out 
#pragma HLS INTERFACE m_axi port=layer_cache  offset=slave bundle=gmem2 max_write_burst_length=128
#pragma HLS INTERFACE m_axi port=out_intersect  offset=slave bundle=gmem3 max_write_burst_length=128
