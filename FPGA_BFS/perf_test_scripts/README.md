...
--out_json_fname FPGA_perf_1_PE_5_runs.json \
--overwrite 0 \
...
--num_runs 5 > log_run_all_experiments


python run_all_experiments.py \
--out_json_fname FPGA_perf_2_PE_5_runs.json \
--overwrite 0 \
...
python run_all_experiments.py \
--out_json_fname FPGA_perf_4_PE_5_runs.json \
--overwrite 0 \
...
python run_all_experiments.py \
--out_json_fname FPGA_perf_8_PE_5_runs.json \
--overwrite 0 \
...
python run_all_experiments.py \
--out_json_fname FPGA_perf_16_PE_5_runs.json \
--overwrite 0 \
