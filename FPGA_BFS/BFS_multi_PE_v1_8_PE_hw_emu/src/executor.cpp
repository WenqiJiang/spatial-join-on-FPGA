...
#pragma HLS INTERFACE m_axi port=out_intersect  offset=slave bundle=gmem3
    ...
    // debug signals
#pragma HLS INTERFACE axis port=axis_debug_read_PE_finish
#pragma HLS INTERFACE axis port=axis_debug_join_PE_finish
#pragma HLS INTERFACE axis port=axis_debug_aggregate_idle_finish
#pragma HLS INTERFACE axis port=axis_debug_cache_manager_finish
#pragma HLS INTERFACE axis port=axis_debug_write_PE_finish
...
#pragma HLS stream variable=s_finish_join_PE_out_aggregated depth=2
    ...
    hls::stream<int> s_finish_join_idle_aggregated; 
#pragma HLS stream variable=s_finish_join_idle_aggregated depth=2
...
#pragma HLS unroll
    ...
    aggregate_join_PE_idle(
        ...
        s_finish_join_PE_out_aggregated,
        s_finish_join_idle_aggregated,
        axis_debug_aggregate_idle_finish);
    ...
    layer_cache_memory_controller(
        ...
        axis_debug_cache_manager_finish
    );
