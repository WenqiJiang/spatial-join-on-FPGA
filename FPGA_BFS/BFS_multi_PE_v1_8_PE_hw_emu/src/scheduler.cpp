...
#pragma HLS INTERFACE axis port=axis_debug_write_PE_finish
    ...
    volatile int tmp0, tmp1, tmp2, tmp3, tmp4;
    tmp0 = block_read<int>(axis_debug_read_PE_finish); 
    tmp1 = block_read<int>(axis_debug_join_PE_finish); 
    tmp4 = block_read<int>(axis_debug_aggregate_idle_finish); 
    tmp2 = block_read<int>(axis_debug_cache_manager_finish);
    tmp3 = block_read<int>(axis_debug_write_PE_finish);
